                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('appointments.store') }}" method="POST">
                                    ...
                                    <div class="form-group m-3">
                                        <input type="date" name="date" placeholder="Pick date" class="form-control"
                                            required>
                                    </div>
                                    <div class="row m-1">
...
<section class="home-testimonial mb-5">
                ...
                <div class="container testimonial-inner">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-4 style-3">
                            <div class="tour-item ">
                                <div class="tour-desc bg-white">
                                    <div class="tour-text color-grey-3 text-center">&ldquo;I recently visited this salon and had an amazing experience! 
                                        The staff was incredibly friendly and attentive. Definitely coming again!&rdquo;</div>
                                    <div class="d-flex justify-content-center pt-2 pb-2"><img class="tm-people"
                                            src="{{ asset('assets/img/p01.jpg')}}"
                                            alt=""></div>
                                    <div class="link-name d-flex justify-content-center">Tariro Chakandinkaira</div>
                        ...
                        <div class="col-md-4 style-3">
                            <div class="tour-item ">
                            <div class="tour-desc bg-white">
                                    <div class="tour-text color-grey-3 text-center">&ldquo;I've been going to this salon for years, and I can't say enough good things about it. The entire team is professional and highly skilled. &rdquo;</div>
                                    <div class="d-flex justify-content-center pt-2 pb-2"><img class="tm-people"
                                            src="{{ asset('assets/img/p02.jpg')}}"
                                            alt=""></div>
                        ...
                        <div class="col-md-4 style-3">
                            <div class="tour-item ">
                            <div class="tour-desc bg-white">
                                    <div class="tour-text color-grey-3 text-center">&ldquo; had an incredible experience at this salon. The staff members were not only talented but also welcoming and friendly. &rdquo;</div>
                                    <div class="d-flex justify-content-center pt-2 pb-2"><img class="tm-people"
                                            src="{{ asset('assets/img/p03.jpg')}}"
                                            alt=""></div>
   ...
   <div class="container-fluid pb-1 mt-5" style="height: 400; background-color : #7B014C; margin-top: 250px !important" id="contact">
